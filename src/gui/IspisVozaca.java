...
public class IspisVozaca extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            ResultSet st=kon.ispis();
            if(st!=null){
                while(st.next()){
                    
                    String ime=st.getString("ime");
                    String prezime=st.getString("prezime");
                    String marka=st.getString("marka");
                    String tip=st.getString("tip");
                    String godiste=st.getString("godiste");
                   

                    String podaci []={ ime,prezime, marka, tip,godiste};
